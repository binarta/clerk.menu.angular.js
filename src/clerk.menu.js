(function () {
    ...
    angular.module('clerk.menu', ['ngRoute', 'checkpoint', 'i18n', 'toggle.edit.mode', 'config', 'application', 'binarta-checkpointjs-angular1'])
        ...
        .service('binartaMenuRunner', ['$rootScope', '$document', '$window', '$compile', '$location', '$routeParams', 'account', 'config', 'applicationDataService', 'binarta', binartaMenuRunnerService]);
    ...
    function binartaMenuRunnerService($rootScope, $document, $window, $compile, $location, $routeParams, account, config, application, binarta) {
